...
export const LEAGUE_CLIENT_ID = process.env.LEAGUE_CLIENT_ID || '401518684763586560'; // Official League of Legends Discord app ID
export const MIN_GAME_DURATION_MS = parseInt(process.env.MIN_GAME_DURATION_MS || '900000'); // 15 minutes in milliseconds
export const LEAGUE_REWARD_POINTS = parseInt(process.env.LEAGUE_REWARD_POINTS || '30');

// Quiz System Constants
export const QUIZ_INTERVAL_MS = parseInt(process.env.QUIZ_INTERVAL_MS || '7200000'); // 2 hours in milliseconds
...
export const SHUTDOWN_MULTIPLIER = parseInt(process.env.SHUTDOWN_MULTIPLIER || '10');
